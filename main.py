...
def main():
    ...
    if not OPENAI_API_KEY :
        logger.error("OPENAI_API_KEY not found. Ensure that your .env file is correctly set up.")
        return
    ...
    try:
        ...
        # Input text for verification - you can replace this with any other text
        input_text = "Hemos dado otro golpe contundente a la jerarquía de estos grupos terroristas mientras la oposición se dedica a sabotear nuestro progreso."
